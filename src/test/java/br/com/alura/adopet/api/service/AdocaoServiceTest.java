...
class AdocaoServiceTest {
    ...
    void testSalvarAdocaoAoSolicitar() {
        ...
        this.dto = new SolicitacaoAdocaoDTO(1L, 1L, "Adoção");
    ...
    void testValidarAdocaoAoSolicitar() {
        ...
        then(validacaoPetAdocaoEmAndamento).should().validar(dto);
        then(validacaoTutorAdocaoEmAndamento).should().validar(dto);
    }
}